                              ...
                              @endif
                                <form class="" action="admin/khachsan/sua/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                        <div class="form-group"><label>Tên khách sạn</label>
                                        ...
                                        <div class="form-group"><label>Giá trung bình</label>
                                        ...
                                        <div class="form-group"><label>Số phòng</label>
                                        ...
                                        <div class="form-group"><label>Địa chỉ cụ thể</label>
                                        ...
                                        <div class="form-group"><label >Đánh giá</label>
                                            <div class=""><select class="form-control" name="Sao">
                                                    @if($tintuc->Sao==1)
