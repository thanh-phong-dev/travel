            ...
            <div class="card-body">
               ...
               <div class="alert alert-danger">
                  ...
                  <div class="alert alert-success">
                     {{session('thongbao')}}
                     @endif
                     <form action="admin/khachsan/themphong" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                        <div class="form-group">
                           <label>Tên Phòng</label>
                           <select class="form-control" name="idkhachsan" >
                              @foreach($khachsan as $tl)
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <input type="text" name="Ten" class="form-control" required placeholder="Nhập tên phòng">
                           </div>
                        </div>
                        <div class="form-group">
