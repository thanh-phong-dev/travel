...
<head>
    ...
    <base href="{{asset('')}}">
    <link rel="shortcut icon" href="Admin_MonNgonViet/assets/images/favicon.ico">
    <!-- DataTables -->
...
<body>
    {{-- thanhotren --}}
    <div id="wrapper">
        @include('admin.layout.menuuser') @yield('content')
    </div>
    ...
    <script src="Admin_MonNgonViet/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Required datatable js -->
    <script src="Admin_MonNgonViet/plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="Admin_MonNgonViet/plugins/datatables/dataTables.bootstrap4.min.js"></script>
    <!-- Buttons examples -->
    ...
    <script src="Admin_MonNgonViet/plugins/datatables/buttons.colVis.min.js"></script>
    <!-- Responsive examples -->
    <script src="Admin_MonNgonViet/plugins/datatables/dataTables.responsive.min.js"></script>
    <script src="Admin_MonNgonViet/plugins/datatables/responsive.bootstrap4.min.js"></script>
    <!-- Datatable init js -->
    <script src="Admin_MonNgonViet/assets/pages/datatables.init.js"></script>
    <!-- App js -->
