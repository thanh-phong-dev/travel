...
<body id="top" class="thebg" style="">
                ...
                <div class="col-md-12 pagecontainer2 offset-0">
                    ...
                    <div class="hpadding50c">
                        ...
                        <div class="col-md-8 cpdd01 grey2">
                            ...
                            ?>
                            <span class="grey">{{$dd->created_at}}<a href="#"> {{$demcomment}} bình luận</a> <a href="#"></a>/ đăng bởi <a href="#">{{$dd->NguoiDang}}</a></span><br>
                            <div class="line4"></div>
                            
                             <a href="chi-tiet/{{$dd->id}}/{{$dd->TieuDeKhongDau}}.html"> <button  type="submit" class="btn-search5">Trả lời<span class="glyphicon glyphicon-arrow-right"></span></button></a>
                            <br><br>
                            @endforeach
                            <script>
                            //------------------------------
    ...
    <div id="ascrail2000" style="width: 5px; z-index: 9000; position: fixed; top: 0px; height: 100%; right: 0px;"><div style="position: relative; top: 12px; float: right; width: 5px; height: 39px; background-color: rgb(204, 204, 204); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div><div id="ascrail2000-hr" style="height: 6px; z-index: 9000; position: fixed; left: 0px; width: 100%; bottom: 0px; display: none;"><div style="position: relative; top: 0px; height: 5px; width: 1366px; background-color: rgb(204, 204, 204); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div></div></body>
@endsection