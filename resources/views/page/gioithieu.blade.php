...
<body id="top" class="thebg" style="">
            ...
            <div class="hpadding50c">
               ...
               <div class="col-md-4">
                  <div class="abover ohidden">
                     ...
                     <div class="chart none easyPieChart" data-percent="69" style="float: right; margin-top: -60px; right: 10px; width: 50px; height: 50px; line-height: 50px;">
   ...
   <div id="ascrail2000" style="width: 5px; z-index: 9000; position: fixed; top: 0px; height: 100%; right: 0px;">
      <div style="position: relative; top: 0px; float: right; width: 5px; height: 48px; background-color: rgb(204, 204, 204); border: 0px solid rgb(255, 255, 255); background-clip: padding-box; border-radius: 0px;"></div>
   </div>
