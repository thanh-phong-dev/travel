    ...
    <div class="container pagecontainer offset-0">	
        ...
        <div class="col-md-8 details-slider">
            ...
            <div id="inner">
                <div id="caroufredsel_wrapper2">
                    <div class="caroufredsel_wrapper" style="display: block; text-align: start; float: none; position: relative; top: auto; right: auto; bottom: auto; left: auto; z-index: auto; width: 759px; height: 427px; margin: 0px; overflow: hidden;">
                    <div id="carousel" style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 9867px; height: 427px; z-index: auto; opacity: 1;">
                    <img src="upload/khachsan/{{$khachsan->Hinh}}" alt="" style="width: 759px;"><img src="upload/khachsan/{{$khachsan->Hinh}}" alt="{{$khachsan->Ten}}" style="width: 759px;"><img src="images/details-slider/slide5.jpg" alt="" style="width: 759px;"><img src="images/details-slider/slide6.jpg" alt="" style="width: 759px;"><img src="images/details-slider/slide1.jpg" alt="" style="width: 759px;"><img src="images/details-slider/slide2.jpg" alt="" style="width: 759px;"></div></div>
                </div>
                {{-- <div id="pager-wrapper">
                    ...
                    <img src="images/details-slider/slide1.jpg" width="120" height="68" alt="" class="" style="margin-right: 10px;"><img src="images/details-slider/slide2.jpg" width="120" height="68" alt="" class="" style="margin-right: 10px;"><img src="images/details-slider/slide3.jpg" width="120" height="68" alt="" class="selected" style="margin-right: 10px;"><img src="images/details-slider/slide4.jpg" width="120" height="68" alt="" class="" style="margin-right: 10px;"><img src="images/details-slider/slide5.jpg" width="120" height="68" alt="" style="margin-right: 39px;" class=""><img src="images/details-slider/slide6.jpg" width="120" height="68" alt="" class="" style="margin-right: 40px;"></div></div>
                </div> --}}
            </div>
            <div class="clearfix"></div>
            {{-- <button id="prev_btn2" class="prev2" style="display: block;"><img src="images/spacer.png" alt=""></button>
            <button id="next_btn2" class="next2" style="display: block;"><img src="images/spacer.png" alt=""></button>		 --}}
        ...
        <div class="col-md-4 detailsright offset-0">
            ...
            <div class="hpadding20">
                ...
                <a href="#" class="booknow margtop20 btnmarg">Đặt phòng</a>
            </div> --}}
        </div>
        <!-- END OF RIGHT INFO -->
                ...
                <div id="roomrates" class="tab-pane fade active in">
                    ...
                    <div class="padding20">
                        ...
                        <div class="col-md-8 offset-0">
                            ...
                            <a href="thanh-toan/{{$pks->id}}/{{$pks->TenKhongDau}}.html"><button class="bookbtn mt1">Đặt phòng</button></a>	
                            </div>										
                        </div>
                        <div class="clearfix"></div>
                    </div>
